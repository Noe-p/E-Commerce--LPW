 ...
 */
final class Version20220307111212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer_address ADD is_select TINYINT(1) NOT NULL');
    }
