 ...
 */
final class Version20220305144330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE order_number_id order_number_id INT DEFAULT NULL');
    }
