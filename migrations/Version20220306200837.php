 ...
 */
final class Version20220306200837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP address_id, DROP last_name, DROP first_name, DROP phone, CHANGE email email VARCHAR(180) NOT NULL');
    }
